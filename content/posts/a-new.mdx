...
```typescript:lib/mdx.ts {1,3-4} showLineNumbers
...
```sql:lib/main.sql {1,3-4} showLineNumbers
...
```typescript:lib/main.tsx {1,3-4} showLineNumbers
const views = snapshot.val();
...
- Export JSON data from my Firebase Realtime Database
  ...
  <Image
    ...
    src={`/assets/mysql-planetscale/firebase.png`}
    width={2905 / 2}
    height={1959 / 2}
  />
...
- Export JSON data from my Redis cluster using `HVALS` and TablePlus
  ...
  <Image
    ...
    src={`/assets/mysql-planetscale/redis.png`}
    width={2540 / 2}
    height={1852 / 2}
  />
...
<Image
  ...
  src={`/assets/mysql-planetscale/checkly.png`}
  width={1490}
  height={528}
/>
...
<Image
  ...
  src={`/assets/mysql-planetscale/checkly-firebase.png`}
  width={2264 / 2}
  height={1076 / 2}
/>
